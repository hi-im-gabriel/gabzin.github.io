...
(function (w, d, u) {
    ...
    var linguLoader = function () {
        ...
        var cssCode = "a.lingumania_target, a.lingumania_poweredby { display: none; background-color: transparent; } #lingumania_custom_id { display: block; color: #fff; display: block; width: 160px; padding: 5px; text-decoration: none; } a.lingumania_target:hover, a.lingumania_poweredby:hover { background-color: #999; } #lingumania_langswitcher{ position: absolute; top: 0px; left: 0px; z-index: 100001; text-transform: uppercase; text-align: left; color: #fff; font-size: 12px; line-height: 18px; } #lingumania_langswitcher:hover a { display: block; position: relative; z-index: 100002; float: left; width: 160px; padding: 5px; clear: both; color: #fff; text-decoration: none; } a#lingumania_currentlanglink { display: block; width: 160px; padding: 5px; color: #fff; font-weight: bold; text-decoration: none; }  .lingumania_poweredby { background: url('//az596610.vo.msecnd.net/lingumania.png') left center no-repeat; border-top: 1px solid #808080; font-size: 9px; line-height: 12px; }";
